...
$lang = array_merge($lang, [
	...
	'WEBPUSH_METHOD_ENABLED'		=> 'Включить веб-уведомления для пользователей по умолчанию',
	'WEBPUSH_METHOD_ENABLED_EXPLAIN'=> 'Когда эта настройка включена, пользователи, подписавшиеся и разрешившие уведомления браузера, будут автоматически их получать. Им нужно будет лишь зайти в настройки уведомлений в ЛКП, чтобы отключить нежелательные уведомления.<br><br>Если эта настройка отключена, пользователи не будут получать уведомления, даже если они подписались, до тех пор, пока не зайдут в настройки уведомлений в ЛКП и не включат конкретные уведомления, которые они хотят получать.',
	'WPN_WEBPUSH_DROPDOWN_SUBSCRIBE'		=> 'Показать кнопку «Подписаться» в выпадающем меню уведомлений',
	'WPN_WEBPUSH_DROPDOWN_SUBSCRIBE_EXPLAIN'=> 'Включить или отключить кнопку «Подписаться» в выпадающем меню уведомлений, позволяя пользователям легко подписываться на push-уведомления с любой страницы форума.',
]);
