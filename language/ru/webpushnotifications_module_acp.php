...
$lang = array_merge($lang, [
	...
	'WEBPUSH_DROPDOWN_SUBSCRIBE_EXPLAIN'=> 'Включить или отключить кнопку «Подписаться» в выпадающем меню уведомлений, позволяя пользователям легко подписываться на push-уведомления с любой страницы форума.',
]);
